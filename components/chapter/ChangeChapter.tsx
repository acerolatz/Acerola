...
const ChangeChapter = ({
  ...
  return (
    <View style={{flexDirection: 'row', alignItems: "center", gap: 10, justifyContent: "flex-start"}} >
      ...
      {
        !isFirstChapter &&
        <Pressable onPress={goToPreviousChapter} style={{alignItems: "center", justifyContent: "center", marginTop: 2}} hitSlop={AppConstants.HIT_SLOP} >
      ...
      {
        !isLastChapter &&
        <Pressable onPress={goToNextChapter} style={{alignItems: "center", justifyContent: "center", marginTop: 2}}  hitSlop={AppConstants.HIT_SLOP}>
